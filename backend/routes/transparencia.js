...
router.put("/rendiciones/:id", verificarToken, async (req, res) => {
  try {
    ...
    const rendicionActualizada =
      await Transparencia.findOneAndUpdate(
        {
          _id: req.params.id,
          tipo: "rendicion",
        },
...
router.delete(
  ...
  async (req, res) => {
    try {
      const rendicionEliminada =
        await Transparencia.findOneAndDelete({
          _id: req.params.id,
          tipo: "rendicion",
        });
...
router.get(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "Error al obtener configuración de colaboración:",
        error,
      );
...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.error(
        "Error al guardar configuración de colaboración:",
        error,
      );
